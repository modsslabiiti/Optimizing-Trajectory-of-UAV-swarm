function [A,Atrain] = Polyfitting5(X,Time)
...
A = zeros(6,M2); % Initialize Coefficient Matrix
T = Time(end,:);
for i = 1:M2
t = Time(:,i);
C = [t.^5,t.^4,t.^3,t.^2,t,ones(201,1)];
d = X(:,i);
Aed = [1,0,0,0,0,0;T(i)^5,T(i)^4,T(i)^3,T(i)^2,T(i),1];% Constraint Ends
bed = [0,X(end,i)];
